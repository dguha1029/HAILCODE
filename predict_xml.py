...
def main(args):
    ...
    if args.wsi == ' ':
        ...
        call(['python3', '/Users/deyaa/OneDrive/Desktop/Deeplab-v2--ResNet-101--Tensorflow-master/main.py', '--option', 'predict',
        ...
        call(['python3', '/Users/deyaa/.vscode/H-AI-L/Codes/Deeplab_network/main.py', '--option', 'predict',
            '--test_data_list', dirs['outDir']+fileID+dirs['txt_save_dir']+test_data_list,
...
def file_len(fname): # get txt file length (number of lines)
    num_lines = sum(1 for line in open(fname,'r') if line.rstrip())
...
def chop_suey(dirs, downsample, region_size, step, args): # chop wsi
    ...
    with parallel_backend('threading'):
        Parallel(n_jobs=num_cores)(delayed(chop_wsi)(slide=slide, yStart=i, xStart=j, f_name=f_name, f2_name=f2_name, dirs=dirs, downsample=downsample, region_size=region_size, args=args) for i in index_y for j in index_x)
...
def chop_wsi(slide, yStart, xStart, f_name, f2_name, dirs, downsample, region_size, args): # perform cutting in parallel
    import numpy as np
...
if __name__ == '__main__':
    ...
    parser.add_argument('--wsi', dest='wsi', default='/Users/deyaa/OneDrive/Desktop/HAIL/WSIPath/GU20-0331 955 LTL.ndpi' ,type=str,
        help='Please specify the whole slide image path')

    ### Params for saving results ###
    parser.add_argument('--outDir', dest='outDir', default="/Users/deyaa/OneDrive/Desktop/HAIL/OutputDir" ,type=str,
    help='output directory')
    parser.add_argument('--xml_save_dir', dest='xml_save_dir', default="/Users/deyaa/OneDrive/Desktop/HAIL/XMLSave" ,type=str,
    help='directory where xml file is saved')
    parser.add_argument('--save_outputs', dest='save_outputs', default=True ,type=bool,
